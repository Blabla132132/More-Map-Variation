...
$Event(0, Default, function() {
    ...
    $InitializeCommonEvent(0, 90065910, 49560200, 49560205, 49560800, 473000, 690047, 49565210, 49560800, 904955000, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90065911, 49560200, 49560800, 473000, 49565210, 49560800, 904955000, 0, 0, 0, 0, 0);
    if (!IsMapVariation(2)) {
        $InitializeCommonEvent(0, 90065900, 49560800, 1, 0, 0, 1050, 473000, 904955000, 49560800);
    }
    ...
    if (IsMapVariation(2)) {
        ...
        $InitializeCommonEvent(0, 90015023, 49560200, 40, 0, 49565210, 49560800, 904955000, 0, 0, 0, 0);
        $InitializeCommonEvent(0, 90015030, 49560200, 49565210, 40, 473000, 0);
        $InitializeCommonEvent(0, 90015002, 0, 49560200, 0, 49565210, 1020, 473000, 110320, 904955000, 49560800);
