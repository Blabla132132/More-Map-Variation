...
$Event(0, Default, function() {
    ...
    $InitializeCommonEvent(0, 90015000, 0, 46660810, 904770000, 30, 0, 0);
    $InitializeCommonEvent(0, 90015030, 0, 46660810, 30, 931010, 0);
    $InitializeCommonEvent(0, 90015002, 0, 0, 46660810, 46660810, 1020, 931010, 11290, 904770001, 46660810);
    $InitializeCommonEvent(0, 9005810, 46660810, 46660500, 46661500, 5);
    $InitializeCommonEvent(0, 90015005, 46661500, 46662800, 46660810);
    $InitializeCommonEvent(0, 90015000, 0, 46660820, 904260307, 30, 0, 0);
    $InitializeCommonEvent(0, 90015030, 0, 46660820, 30, 931010, 0);
    $InitializeCommonEvent(0, 90015002, 0, 0, 46660820, 46660820, 1020, 931010, 11290, 904770001, 46660820);
    $InitializeCommonEvent(0, 9005810, 46660820, 46660500, 46661500, 5);
    $InitializeCommonEvent(0, 90015005, 46661500, 46662800, 46660820);
    $InitializeCommonEvent(0, 90015000, 0, 46660830, 904260307, 30, 0, 0);
    $InitializeCommonEvent(0, 90015030, 0, 46660830, 30, 931010, 0);
    $InitializeCommonEvent(0, 90015002, 0, 0, 46660830, 46660830, 1020, 931010, 11290, 904770001, 46660830);
