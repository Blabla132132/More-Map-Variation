...
$Event(0, Default, function() {
    ...
    $InitializeCommonEvent(0, 90065910, 49510200, 49510205, 49510800, 475000, 690047, 49515210, 49510800, 905011000, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90065911, 49510200, 49510800, 475000, 49515210, 49510800, 905011000, 0, 0, 0, 0, 0);
    if (!IsMapVariation(2)) {
        $InitializeCommonEvent(0, 90065900, 49510800, 1, 0, 0, 1050, 475000, 905011000, 49510800);
    }
    ...
    $InitializeCommonEvent(0, 90015008, 49510205, 49510800, 475000, 49510800, 14771, 0);
    if (IsMapVariation(2)) {
        ...
        $InitializeCommonEvent(0, 90015030, 49510200, 49515210, 40, 475000, 0);
        $InitializeCommonEvent(0, 90015002, 0, 49510200, 0, 49515210, 1020, 475000, 110320, 905011000, 49510800);
