...
$Event(0, Default, function() {
    ...
    $InitializeCommonEvent(0, 90065910, 49620200, 49620205, 49620800, 950010, 690047, 49625210, 49620800, 904972000, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90065911, 49620200, 49620800, 950010, 49625210, 49620800, 904972000, 0, 0, 0, 0, 0);
    if (!IsMapVariation(2)) {
        $InitializeCommonEvent(0, 90065900, 49620800, 1, 0, 0, 1050, 950010, 904972000, 49620800);
    }
    ...
    $InitializeCommonEvent(0, 90015008, 49620205, 49620800, 950010, 49620800, 14771, 0);
    if (IsMapVariation(2)) {
        $InitializeCommonEvent(0, 90015443, 49622200, 49620800);
        $InitializeCommonEvent(0, 90015023, 49620200, 40, 0, 49625210, 49620800, 904972000, 0, 0, 0, 0);
        $InitializeCommonEvent(0, 90015030, 49620200, 49625210, 40, 950010, 0);
        $InitializeCommonEvent(0, 90015002, 0, 49620200, 0, 49625210, 1020, 950010, 110320, 904972000, 49620800);
