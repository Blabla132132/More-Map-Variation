...
$Event(0, Default, function() {
    ...
    $InitializeCommonEvent(0, 90065910, 49670200, 49670205, 49670800, 475000, 690047, 49675210, 49670800, 904968000, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90065911, 49670200, 49670800, 475000, 49675210, 49670800, 904968000, 0, 0, 0, 0, 0);
    if (!IsMapVariation(2)) {
        $InitializeCommonEvent(0, 90065900, 49670800, 1, 0, 0, 1050, 475000, 904968000, 49670800);
    }
    ...
    if (IsMapVariation(2)) {
        ...
        $InitializeCommonEvent(0, 90015023, 49670200, 40, 0, 49675210, 49670800, 904968000, 0, 0, 0, 0);
        $InitializeCommonEvent(0, 90015030, 49670200, 49675210, 40, 475000, 0);
        $InitializeCommonEvent(0, 90015002, 0, 49670200, 0, 49675210, 1020, 475000, 110320, 904968000, 49670800);
