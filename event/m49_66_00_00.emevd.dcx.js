...
$Event(0, Default, function() {
    ...
    $InitializeCommonEvent(0, 90065124, 49660200, 49660205, 49660800, 920200, 621196, 49665210, 49660800, 902500300, 49660810, 905011000, 0, 0);
    $InitializeCommonEvent(0, 90065911, 49660200, 49660800, 920200, 49665210, 49660800, 902500300, 49660810, 905011000, 0, 0, 0);
    if (!IsMapVariation(2)) {
        $InitializeCommonEvent(0, 90065900, 49660800, 2, 0, 0, 1050, 920200, 902500300, 49660800);
    }
    ...
    $InitializeCommonEvent(0, 90015008, 49660205, 49660800, 920200, 49665210, 14601, 0);
    if (!IsMapVariation(2)) {
        $InitializeCommonEvent(0, 90065123, 49660800, 49660810, 49660200, 49660800, 905011000, 49660206);
    }
    if (IsMapVariation(2)) {
        $InitializeCommonEvent(0, 90065125, 49660800, 49660810, 49660200, 49660800, 905011000, 49660206, 49660207);
    }
    if (IsMapVariation(2)) {
        $InitializeCommonEvent(0, 90015443, 49662200, 49660800);
        $InitializeCommonEvent(0, 90015023, 49660200, 40, 0, 49665210, 49660800, 902500300, 0, 0, 0, 0);
        $InitializeCommonEvent(0, 90015026, 49660206, 40, 0, 49665210, 49660810, 905011000);
        $InitializeCommonEvent(0, 90015030, 49660200, 49665210, 40, 920200, 0);
        $InitializeCommonEvent(0, 90015002, 0, 49660200, 0, 49665210, 1020, 920200, 110320, 902500300, 49660800);
