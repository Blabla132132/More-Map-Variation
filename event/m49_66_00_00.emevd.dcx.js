...
$Event(0, Default, function() {
    ...
    $InitializeCommonEvent(0, 90065124, 49660200, 49660205, 49660800, 950010, 690048, 49665210, 49660800, 904970000, 49660810, 904971000, 0, 0);
    $InitializeCommonEvent(0, 90065911, 49660200, 49660800, 950010, 49665210, 49660800, 904970000, 49660810, 904971000, 0, 0, 0);
    if (!IsMapVariation(2)) {
        $InitializeCommonEvent(0, 90065900, 49660800, 2, 0, 0, 1050, 950010, 904970000, 49660800);
    }
    ...
    $InitializeCommonEvent(0, 90015008, 49660205, 49660800, 950010, 49665210, 14601, 0);
    if (!IsMapVariation(2)) {
    ...
    if (IsMapVariation(2)) {
        ...
        $InitializeCommonEvent(0, 90015030, 49660200, 49665210, 40, 950010, 0);
        $InitializeCommonEvent(0, 90015002, 0, 49660200, 0, 49665210, 1020, 950010, 110320, 904970000, 49660800);
