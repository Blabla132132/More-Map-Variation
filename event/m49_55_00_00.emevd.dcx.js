...
$Event(0, Default, function() {
    ...
    $InitializeCommonEvent(0, 90065910, 49550200, 49550205, 49550800, 475000, 690047, 49555210, 49550800, 904510603, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90065911, 49550200, 49550800, 475000, 49555210, 49550800, 904510603, 0, 0, 0, 0, 0);
    if (!IsMapVariation(2)) {
        $InitializeCommonEvent(0, 90065900, 49550800, 1, 0, 0, 1050, 475000, 904510603, 49550800);
    }
    ...
    $InitializeCommonEvent(0, 90015008, 49550205, 49550800, 475000, 49550800, 14771, 0);
    if (IsMapVariation(2)) {
        ...
        $InitializeCommonEvent(0, 90015030, 49550200, 49555210, 40, 475000, 0);
        $InitializeCommonEvent(0, 90015002, 0, 49550200, 0, 49555210, 1020, 475000, 110320, 904510603, 49550800);
