...
$Event(0, Default, function() {
    ...
    if (EventFlag(64001)) {
        ...
        RandomlySetEventFlagInRange(64010, 64013, ON);
    ...
    $InitializeCommonEvent(0, 90015000, 0, 46515810, 903181400, 30, 0, 0);
    $InitializeCommonEvent(0, 90015030, 0, 46515810, 30, 921410, 0);
    $InitializeCommonEvent(0, 90015002, 0, 0, 46515810, 46515810, 1020, 921410, 11290, 903181300, 46515810);
    $InitializeCommonEvent(0, 9005810, 46510900, 46510500, 46511500, 5);
    $InitializeCommonEvent(0, 90015005, 46511500, 46512800, 46515810);
    $InitializeCommonEvent(0, 90015000, 0, 46515820, 904270600, 30, 0, 0);
    $InitializeCommonEvent(0, 90015030, 0, 46515820, 30, 921410, 0);
    $InitializeCommonEvent(0, 90015002, 0, 0, 46515820, 46515820, 1020, 921410, 11290, 903181300, 46515820);
    $InitializeCommonEvent(0, 9005810, 46515820, 46510500, 46511500, 5);
    $InitializeCommonEvent(0, 90015005, 46511500, 46512800, 46515820);
    $InitializeCommonEvent(0, 90015000, 0, 46515830, 904630310, 30, 0, 0);
    $InitializeCommonEvent(0, 90015030, 0, 46515830, 30, 921410, 0);
    $InitializeCommonEvent(0, 90015002, 0, 0, 46515830, 46515830, 1020, 921410, 11290, 903181300, 46515830);
    $InitializeCommonEvent(0, 9005810, 46515830, 46510500, 46511500, 5);
    $InitializeCommonEvent(0, 90015005, 46511500, 46512800, 46515830);
    $InitializeCommonEvent(0, 90015000, 0, 46515840, 904630310, 30, 0, 0);
    $InitializeCommonEvent(0, 90015030, 0, 46515840, 30, 921410, 0);
    $InitializeCommonEvent(0, 90015002, 0, 0, 46515840, 46515840, 1020, 921410, 11290, 903181300, 46515840);
    $InitializeCommonEvent(0, 9005810, 46515840, 46510500, 46511500, 5);
    $InitializeCommonEvent(0, 90015005, 46511500, 46512800, 46515840);
    $InitializeCommonEvent(0, 90015000, 0, 46510850, 904630310, 30, 0, 0);
    $InitializeCommonEvent(0, 90015030, 0, 46510850, 30, 921410, 0);
    $InitializeCommonEvent(0, 90015002, 0, 0, 46510850, 46510850, 1020, 921410, 11290, 903181300, 46510850);
