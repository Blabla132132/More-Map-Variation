...
$Event(0, Default, function() {
    ...
    $InitializeCommonEvent(0, 90065910, 49580200, 49580205, 49580800, 920610, 690047, 49585210, 49580800, 904958000, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90065911, 49580200, 49580800, 920610, 49585210, 49580800, 904958000, 0, 0, 0, 0, 0);
    if (!IsMapVariation(2)) {
        $InitializeCommonEvent(0, 90065900, 49580800, 1, 0, 0, 1050, 920610, 904958000, 49580800);
    }
    ...
    $InitializeCommonEvent(0, 90015008, 49580205, 49580800, 920610, 49580800, 14771, 0);
    if (IsMapVariation(2)) {
        ...
        $InitializeCommonEvent(0, 90015030, 49580200, 49585210, 40, 920610, 0);
        $InitializeCommonEvent(0, 90015002, 0, 49580200, 0, 49585210, 1020, 920610, 110320, 904958000, 49580800);
