...
$Event(0, Default, function() {
    ...
    $InitializeCommonEvent(0, 90065910, 49650200, 49650205, 49650800, 920710, 690047, 49655210, 49650800, 904965000, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90065911, 49650200, 49650800, 920710, 49655210, 49650800, 904965000, 0, 0, 0, 0, 0);
    if (!IsMapVariation(2)) {
        $InitializeCommonEvent(0, 90065900, 49650800, 1, 0, 0, 1050, 920710, 904965000, 49650800);
    }
    ...
    $InitializeCommonEvent(0, 90015008, 49650205, 49650800, 920710, 49650800, 14771, 0);
    if (IsMapVariation(2)) {
        ...
        $InitializeCommonEvent(0, 90015030, 49650200, 49655210, 40, 920710, 0);
        $InitializeCommonEvent(0, 90015002, 0, 49650200, 0, 49655210, 1020, 920710, 110320, 904965000, 49650800);
