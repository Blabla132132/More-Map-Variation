...
$Event(0, Default, function() {
    ...
    if (EventFlag(64000)) {
       ...
       RandomlySetEventFlagInRange(64010, 64015, ON);
    ...
    $InitializeCommonEvent(0, 90015002, 0, 0, 46625800, 46625800, 1020, 921010, 11290, 903150600, 46625800);
    ...
    $InitializeCommonEvent(0, 90015002, 0, 0, 46625810, 46625810, 1020, 921010, 11290, 903150600, 46625810);
    ...
    $InitializeCommonEvent(0, 90015002, 0, 0, 46625820, 4662582, 1020, 921010, 11290, 903150600, 46625820);
    ...
    $InitializeCommonEvent(0, 90015002, 0, 0, 46625830, 46625830, 1020, 921010, 11290, 903150600, 46625830);
    ...
    $InitializeCommonEvent(0, 90015002, 0, 0, 46625840, 46625840, 1020, 921010, 11290, 903150600, 46625840);
    ...
    $InitializeCommonEvent(0, 90015002, 0, 0, 46625850, 46625850, 1020, 921010, 11290, 903150600, 46625850);
    $InitializeCommonEvent(0, 9005810, 46625850, 46620500, 46621500, 5);
    $InitializeCommonEvent(0, 90015005, 46621500, 46622800, 46625850);
    $InitializeCommonEvent(0, 90015000, 0, 46625860, 904311005, 30, 0, 0);
    $InitializeCommonEvent(0, 90015030, 0, 46625860, 30, 921010, 0);
    $InitializeCommonEvent(0, 90015002, 0, 0, 46625860, 46625860, 1020, 921010, 11290, 903150600, 46625860);
    $InitializeCommonEvent(0, 9005810, 46625860, 46620500, 46621500, 5);
    $InitializeCommonEvent(0, 90015005, 46621500, 46622800, 46625860);
    $InitializeCommonEvent(0, 90015000, 0, 46625870, 904311005, 30, 0, 0);
    $InitializeCommonEvent(0, 90015030, 0, 46625870, 30, 921010, 0);
    $InitializeCommonEvent(0, 90015002, 0, 0, 46625870, 46625870, 1020, 921010, 11290, 903150600, 46625870);
