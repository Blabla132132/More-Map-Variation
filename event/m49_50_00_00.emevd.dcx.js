...
$Event(0, Default, function() {
    ...
    $InitializeCommonEvent(0, 90065910, 49500200, 49500205, 49500800, 472000, 690047, 49505210, 49500800, 903050900, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90065911, 49500200, 49500800, 472000, 49505210, 49500800, 903050900, 0, 0, 0, 0, 0);
    if (!IsMapVariation(2)) {
        $InitializeCommonEvent(0, 90065900, 49500800, 1, 0, 0, 1050, 472000, 903050900, 49500800);
    }
    ...
    $InitializeCommonEvent(0, 90015008, 49500205, 49500800, 472000, 49500800, 14771, 0);
    if (IsMapVariation(2)) {
        ...
        $InitializeCommonEvent(0, 90015030, 49500200, 49505210, 40, 472000, 0);
        $InitializeCommonEvent(0, 90015002, 0, 49500200, 0, 49505210, 1020, 472000, 110320, 903050900, 49500800);
