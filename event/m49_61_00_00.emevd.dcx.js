...
$Event(0, Default, function() {
    ...
    $InitializeCommonEvent(0, 90065910, 49610200, 49610205, 49610800, 475000, 690047, 49615210, 49610800, 904503700, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90065911, 49610200, 49610800, 475000, 49615210, 49610800, 904503700, 0, 0, 0, 0, 0);
    if (!IsMapVariation(2)) {
        $InitializeCommonEvent(0, 90065900, 49610800, 1, 0, 0, 1050, 475000, 904503700, 49610800);
    }
    ...
    $InitializeCommonEvent(0, 90015008, 49610205, 49610800, 475000, 49610800, 14771, 0);
    if (IsMapVariation(2)) {
        ...
        $InitializeCommonEvent(0, 90015030, 49610200, 49615210, 40, 475000, 0);
        $InitializeCommonEvent(0, 90015002, 0, 49610200, 0, 49615210, 1020, 475000, 110320, 904503700, 49610800);
