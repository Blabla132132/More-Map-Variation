...
$Event(0, Default, function() {
    ...
    $InitializeCommonEvent(0, 90065910, 49570200, 49570205, 49570800, 921000, 690047, 49575210, 49570800, 904957000, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90065911, 49570200, 49570800, 921000, 49575210, 49570800, 904957000, 0, 0, 0, 0, 0);
    if (!IsMapVariation(2)) {
        $InitializeCommonEvent(0, 90065900, 49570800, 1, 0, 0, 1050, 921000, 904957000, 49570800);
    }
    ...
    $InitializeCommonEvent(0, 90015008, 49570205, 49570800, 921000, 49570800, 14771, 0);
    if (IsMapVariation(2)) {
        ...
        $InitializeCommonEvent(0, 90015030, 49570200, 49575210, 40, 921000, 0);
        $InitializeCommonEvent(0, 90015002, 0, 49570200, 0, 49575210, 1020, 921000, 110320, 904957000, 49570800);
